...
<html lang="en">
  <head>
    ...
    <title>Add a new SCP Record</title>
    ...
    <style>
      ...
      * { box-sizing: border-box; }
      ...
      .btn-dark a { color: #ffffff; text-decoration: none; }
  ...
  <body>
    ...
    <header class="scp-header">
      ...
      <p class="scp-header-subtitle">Add New Record</p>
    ...
    <div class="page-content">
      ...
      <?php include "connection.php";
         ...
         {
             // prepared statement to insert form contents into scp table
             ...
             {
                 echo"
                    <div class='alert alert-success'>SCP Record Added Successfully</div>
                 ";
             }
             else
             {
      ...
      <h1 class="mb-4">Add a New SCP Record</h1>

      <div class="scp-form-card">
        <form method="post" action="create.php">
          <div class="form-row">
            <label>SCP Subject (e.g. SCP-173):</label>
            <input type="text" name="subject" placeholder="e.g. SCP-173" required class="form-control">
          </div>
          <div class="form-row">
            <label>Object Class (e.g. Safe, Euclid, Keter):</label>
            <input type="text" name="class" placeholder="e.g. Keter" required class="form-control">
          </div>
          <hr>
          <div class="form-row">
            <label>Description:</label>
            <textarea name="description" class="form-control" rows="5" placeholder="Enter SCP description..." required></textarea>
          </div>
          <div class="form-row">
            <label>Containment Procedures:</label>
            <textarea name="containment" class="form-control" rows="5" placeholder="Enter containment procedures..." required></textarea>
          </div>
          <hr>
          <div class="form-row">
            <label>Image (URL or file path e.g. images/scp-173.jpg):</label>
